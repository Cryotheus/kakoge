...
--intent: learn more about HTTP, HTML, and internet images
--status: dunno
--motivation: no one wants to makes scanlations for dragon ego... fine I'll do it myself
...
local config = {
	...
	panels = {
		cropper_annotation = 21,	--10 101
		cropper_image = 21,			--10 101
		cropper_strip = 21,			--10 101
		download_capture = 21,		--10 101
		download_shop = 21,			--10 101
		download_strip = 21,		--10 101
		home = 21,					--10 101
		icon_button = 21,			--10 101
		language_selector = 21,		--10 101
		translation_block = 21,		--10 101
		translation_chain = 21,		--10 101
		translation_header = 21,	--10 101
		translation_network = 21,	--10 101
	},
...
local color_significant = Color(128, 203, 196)
...
local function grab_extensions(extension_directory)
	...
	if files then
		--this tool does not need extensions for gamemode or map
